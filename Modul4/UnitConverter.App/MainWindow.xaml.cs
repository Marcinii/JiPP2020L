...
namespace UnitConverter.App
{
    public partial class MainWindow : Window
    {
        ...
        private void Button_Click_3(object sender, RoutedEventArgs e)
        {
            ...
            {
                readRecords.CommandText = "SELECT TOP 20 * FROM [converted]";
                whichMost.CommandText = "SELECT TOP 3 converted.[Unit_from] + \" -> \" + [Unit_to] AS Conversion, Count(converted.[Unit_from] + \" -> \" + [Unit_to]) AS Countof FROM converted GROUP BY converted.[Unit_from] + \" -> \" +[Unit_to] Order by Count(converted.[Unit_from]+\"-> \"+[Unit_to]) DESC";
            }
            else if (sortValue != "(5) All" & dateFromVal == "" & dateToVal == "")
            {
                readRecords.CommandText = "SELECT TOP 20 * FROM [converted] WHERE [Converter_type] ='" + sortValue + "'";
                whichMost.CommandText = "SELECT TOP 3 converted.[Unit_from] + \" -> \" + [Unit_to] AS Conversion, Count(converted.[Unit_from] + \" -> \" + [Unit_to]) AS Countof FROM converted WHERE [Converter_type] ='" + sortValue + "' GROUP BY converted.[Unit_from] + \" -> \" +[Unit_to] Order by Count(converted.[Unit_from]+\"-> \"+[Unit_to]) DESC";
            }
            else if (sortValue == "(5) All" & dateFromVal != "" & dateToVal != "")
            {
                ...
                whichMost.CommandText = "SELECT TOP 3converted.[Unit_from] + \" -> \" +[Unit_to] AS Conversion, Count(converted.[Unit_from] + \" -> \" +[Unit_to]) AS Countof FROM converted WHERE(((converted.Date_of_conversion) >=#" + dateFromVal + "# And (converted.Date_of_conversion)<=#" + dateToVal + "#)) GROUP BY converted.[Unit_from] + \" -> \" +[Unit_to] Order by Count(converted.[Unit_from]+\"-> \"+[Unit_to]) DESC";
            }
            else if (sortValue != "(5) All" & dateFromVal != "" & dateToVal != "")
            {
                ...
                whichMost.CommandText = "SELECT TOP 3 converted.[Unit_from] + \" -> \" +[Unit_to] AS Conversion, Count(converted.[Unit_from] + \" -> \" +[Unit_to]) AS Countof FROM converted WHERE [Converter_type] ='" + sortValue + "' And (((converted.Date_of_conversion) >=#" + dateFromVal + "# And (converted.Date_of_conversion)<=#" + dateToVal + "#)) GROUP BY converted.[Unit_from] + \" -> \" +[Unit_to] Order by Count(converted.[Unit_from]+\"-> \"+[Unit_to]) DESC";
            }
