...
namespace Konwerter_jedn
{
    public class odleglosci: IKonwerter_jedn
    {
        ...
        public string naPodst(string Zjakiej, string daneStr) //cos na metry
        {
        ...
        public string naWybr(string Zjakiej, string DOjakiej, string daneStr) //z metrow na cos
        {
            double wmetrach = double.Parse(naPodst(Zjakiej, daneStr));
            if (DOjakiej == "km")
            {
