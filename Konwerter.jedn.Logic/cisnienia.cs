...
namespace Konwerter_jedn
{
    public class cisnienia : IKonwerter_jedn
    {
        ...
        public string naPodst(string Zjakiej, string daneStr) //cos na paskale
        {
        ...
        public string naWybr(string Zjakiej, string DOjakiej, string daneStr) //z paskali na cos
        {
            double wPa = double.Parse(naPodst(Zjakiej, daneStr));
