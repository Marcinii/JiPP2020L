...
namespace AccountCreator
{
    ...
    public class EUWAccountCreatorLogic : IServer
    {
        public string Serwer => "EUW";
        ...
        public void Account_creator(string serwer, string email, string username, string password)
        {
            ...
            if (serwer == "EUW")
            {
                ...
                s.Keyboard.TextEntry(@"chrome signup.euw.leagueoflegends.com/en/signup/index");
