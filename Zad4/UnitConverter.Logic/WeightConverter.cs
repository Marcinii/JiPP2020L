...
namespace UnitConverter
{
    public class WeightConverter : IConverter
    {
        ...
        public string Convert(string unitFrom, string unitTo, string valueToConvert)
        {
            ...
            {
                wynik = System.Convert.ToDouble(valueToConvert) * 2.2046;
            }
            ...
            {
                wynik = System.Convert.ToDouble(valueToConvert) / 1000.0;
            }
            ...
            {
                wynik = System.Convert.ToDouble(valueToConvert) / 2204.62262;
            }
